...
public class BankStatement {
    ...
    private static final String FILE = "/Users/gsure-tech/IdeaProjects/MyStatement.pdf";
    /**
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Quick Pay"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("12, College road, Abuja Nigeria"));
